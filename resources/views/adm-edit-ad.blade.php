            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-10">
                    <div class="form-group">
                        ...
                        <input value="{{$ad->name}}" name="name" type="text" class="form-control"
                ...
                <div class="col-10">
                    <div class="form-group">
                        ...
                        <input value="{{$ad->url}}" name="url" type="text" class="form-control" id="exampleInputEmail1"
                ...
                <div class="col-10">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control" id="exampleFormControlSelect1">
                            ...
                            <option selected value="{{$ad->type}}">{{$ad->type}}</option>
                ...
                <div class="col-10">
                    ...
                    <div class="form-group ">
                        ...
                        <img class="image-ad mt-3" src="/storage/{{$ad->image}}" alt="">
